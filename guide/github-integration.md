...
page_title: GitHub
description: Connect GitHub with Zepel to streamline your development workflow
...
When you connect your GitHub repository to your Zepel Squad, you can easily:
...
![Connect to Git](/guide/assets/uploads/zepel-connect-to-git-repository.png)

* From the pop-up, click on "**Link to GitHub**".

![Connect to Git](/guide/assets/uploads/zepel-link-to-github.png)

* You'll be prompted to log in to your GitHub account, if you're logged out.

* Once you log in, you'll be asked to give Zepel permissions. Click "**Authorize**".

* Once authorized, your Zepel account will now be integrated with GitHub.
